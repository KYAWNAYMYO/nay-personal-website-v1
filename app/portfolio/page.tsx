...
export const metadata: Metadata = {
    title: 'Portfolio | Nay Myo Kyaw',
    description:
        'Browse open source projects and code experiments by software engineer Nay Myo Kyaw.',
};

async function getRepositories(): Promise<Repo[]> {
    try {
        const response = await fetch(
            'https://api.github.com/users/KYAWNAYMYO/repos?per_page=100',
            {
                headers: {
